...
class AuthenticationForm(forms.Form):
    ...
    """
    identification = identification_field_factory(_("Username"),
...
class EditProfileForm(forms.ModelForm):
    phone = forms.CharField(widget=forms.TextInput(attrs=dict(attrs_dict,maxlength=10)),label=_("Phone"))
    ...
    pickstaff = forms.ChoiceField(choices=pickstaffs,label='Please Select Masseur')
    ...
    time = forms.ChoiceField(choices=times,label='Please Select Service Time ')
    ...
    date = forms.ChoiceField(choices=dates,label='Please Select Service Date ')
   

    class Meta:
        model = get_profile_model()
        exclude = ['user','vip_card_expire_date','blance','mugshot','privacy','first_name','last_name']
