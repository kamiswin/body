...
urlpatterns = patterns('',
    ...
    url(r'^(?P<username>[\@\.\w-]+)/offers/$',
       userena_views.direct_to_user_template,
       {'template_name': 'userena/offers.html'},
       name='userena_offers'),
       
       
    url(r'^(?P<username>[\@\.\w-]+)/informations/$',
       userena_views.direct_to_user_template,
       {'template_name': 'userena/informations.html'},
       name='userena_informations'),

    url(r'^(?P<username>[\@\.\w-]+)/contact/$',
       userena_views.direct_to_user_template,
       {'template_name': 'userena/contact.html'},
       name='userena_contact'),       
       
    url(r'^(?P<username>[\@\.\w-]+)/feedback/$',
       userena_views.direct_to_user_template,
       {'template_name': 'userena/feedback.html'},
       name='userena_feedback'), 
       
    url(r'^(?P<username>[\@\.\w-]+)/order_complete/$',
       userena_views.direct_to_user_template,
       {'template_name': 'userena/order_complete.html'},
       name='userena_order_complete'),
       
       
    url(r'^(?P<username>[\@\.\w-]+)/show_staff/$',
       userena_views.direct_to_user_template,
       {'template_name': 'userena/show_staff.html'},
       name='userena_show_staff'),
